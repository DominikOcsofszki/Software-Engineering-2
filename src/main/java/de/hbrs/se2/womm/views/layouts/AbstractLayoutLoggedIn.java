...
abstract class AbstractLayoutLoggedIn extends AbstractLayout {
    ...
    protected final BenachrichtigungService benachrichtigungService;


    AbstractLayoutLoggedIn(SecurityService securityService, BenachrichtigungService benachrichtigungService) {
