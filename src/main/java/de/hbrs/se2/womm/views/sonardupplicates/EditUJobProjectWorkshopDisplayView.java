...
public class EditUJobProjectWorkshopDisplayView extends UStelleAnzeigeErstellenView implements HasUrlParameter<String> {
    ...
    public EditUJobProjectWorkshopDisplayView(StelleService stelleService, UnternehmenService unternehmenService,
                                              SecurityService securityService,
                                              AboStudentUnternehmenService aboStudentUnternehmenService,
                                              BenachrichtigungService benachrichtigungService) {
        super(stelleService, unternehmenService, securityService, aboStudentUnternehmenService,benachrichtigungService);
