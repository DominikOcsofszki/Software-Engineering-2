...
public class ChatNewView extends AViewWomm {
    ...
    long NutzerIdOther = 2;

    ChatNewView(StudentService studentService, SecurityService securityService,
...
//        this.aboStudentUnternehmenService = aboStudentUnternehmenService;
        ...
        this.studentDTO = studentService.getByNutzerId(nutzerIdLoggedIn);
        if(true) {
